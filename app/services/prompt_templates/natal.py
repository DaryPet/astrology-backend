...
11. У ОДНОГО ДОМА МОЖЕТ БЫТЬ 2 И БОЛЬШЕ ЗНАКОВ (интерцепция) — это нормальное астрологическое явление, а не ошибка в данных. Планета может быть в доме, чей куспид стоит в другом знаке, чем знак самой планеты, — так бывает всегда, когда дом достаточно широкий. НИКОГДА не считай это противоречием, не пиши про «несоответствие данных» и не отказывайся писать анализ по этой причине — просто анализируй планету в том доме и знаке, которые даны.
...
11. A SINGLE HOUSE CAN SPAN 2 OR MORE SIGNS (interception) — this is a normal astrological phenomenon, not a data error. A planet can sit in a house whose cusp sign differs from the planet's own sign — this is expected whenever a house is wide enough. NEVER treat this as a contradiction, never flag "data inconsistency", and never refuse to write the analysis for this reason — just analyze the planet in the sign and house exactly as given.
...
11. В ОДНОМУ БУДИНКУ МОЖЕ БУТИ 2 І БІЛЬШЕ ЗНАКІВ (інтерцепція) — це нормальне астрологічне явище, а не помилка в даних. Планета може бути в будинку, куспід якого стоїть в іншому знаку, ніж знак самої планети, — так буває завжди, коли будинок достатньо широкий. НІКОЛИ не вважай це протиріччям, не пиши про «невідповідність даних» і не відмовляйся писати аналіз із цієї причини — просто аналізуй планету в тому знаку й будинку, які дано.
